        ...
        <div class="container mx-auto">
            <div class="grid md:grid-cols-3 gap-4 items-center">
                <div class="flex justify-center md:justify-start">
                    <ul class="flex">
                        <li
                            class="mr-4 pr-5 relative last:mr-0 after:content-[''] after:absolute after:w-1 after:h-1 after:top-1/2 after:transform after:-translate-y-1/2 after:right-0 after:bg-white after:rounded-full last:after:content-none">
                            <router-link to="/contact" class="text-white">Help</router-link>
                        </li>
                        <li
                            class="mr-4 pr-5 relative last:mr-0 after:content-[''] after:absolute after:w-1 after:h-1 after:top-1/2 after:transform after:-translate-y-1/2 after:right-0 after:bg-white after:rounded-full last:after:content-none">
                            <router-link to="/about" class="text-white">Status</router-link>
                        </li>
                        <li
                            class="mr-4 pr-5 relative last:mr-0 after:content-[''] after:absolute after:w-1 after:h-1 after:top-1/2 after:transform after:-translate-y-1/2 after:right-0 after:bg-white after:rounded-full last:after:content-none">
                            <router-link to="/about" class="text-white">Writers</router-link>
                        </li>
                    </ul>
                </div>
                <div class="header-top__info">
                    <ul class="flex justify-center text-white space-x-10">
                        <li class="flex items-center">
                            ...
                            <a class="text-white" href="callto:0123456789">+503 6162-1431</a>
                        </li>
                        <li class="flex items-center">
                            ...
                            <a class="text-white" href="mailto:address@gmail.com">soporteitca@itca.edu.sv</a>
                        </li>
                    </ul>
                </div>
