<template>
    <main class="bg-white">
                        ...
                        <div class="max-w-md mx-auto">
                            ...
                            <form>
                                ...
                                <div class="flex items-center justify-between space-x-6 mb-8">
                                    <div>
                                        <div class="font-medium text-slate-800 text-sm mb-1">💸 Lorem ipsum is place text
                                            commonly?</div>
                                        <div class="text-xs">Lorem ipsum is placeholder text commonly used in the graphic,
        ...
        <div class="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
            <img class="object-cover object-center w-full h-full" src="../../../static/image/banners/dev1.jpg"
