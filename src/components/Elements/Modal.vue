            ...
            <div v-show="show" class="fixed inset-0 overflow-y-auto flex items-center justify-center px-4 py-6 sm:px-0 z-50"
                ...
                <transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0"
                    ...
                    <div v-show="show" class="fixed inset-0 transform transition-all" @click="closeOutSide">
                        <div class="absolute inset-0 bg-gray-900 opacity-30" />
                    </div>
                </transition>
                ...
                <transition enter-active-class="ease-out duration-300"
                    ...
                    <div class="sin-scroll sm:px-6 lg:px-10 pb-4 sm:pb-8 pt-2 sm:pt-4 text-base w-full max-w-9xl mx-auto inset-x-0 bottom-0 max-h-full overflow-y-auto bg-white rounded shadow-xl transform transition-all sm:w-full sm:mx-auto"
